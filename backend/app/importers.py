...
ENTITY_CONFIG: dict[str, dict[str, object]] = {
    "personnel": {
        ...
        "aliases": {
            ...
            "jogviszonykezdete": "joinDate",
            "szerzodeskezdete": "joinDate",
            "szuletesiido": "birthDate",
            "szuletesiidopont": "birthDate",
            "lakcim": "address",
            "telefonszam": "phone",
            "emailcim": "email",
            "rendfokozata": "rank",
            "szervezetiegyseg": "unit",
            "notes": "notes",
            "megjegyzes": "notes",
            "jogviszony": "serviceType",
            "jogviszonytipusa": "serviceType",
            "jogviszonyjellege": "serviceType",
            "allomanyviszony": "serviceType",
            "servicetype": "serviceType",
        },
        "column_order": ["name", "sztsz", "rank", "unit", "status", "serviceType", "email", "phone", "birthDate", "address", "joinDate", "notes"],
    },
    "exercises": {
