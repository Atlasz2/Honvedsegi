...
from .routers import (
    ...
    qualifications, reference, reports, search, series, supplies, todos, trainings, users, vehicles,
)
...
for _router_module in (
    ...
    announcements, activity_log, qualifications, prerequisites, reference, reports, series, imports, conflicts, availability, alerts, documents, maintenance, campaign, orders, search, todos,
):
